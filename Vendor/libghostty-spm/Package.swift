...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/egoist-labs/libghostty-spm/releases/download/storage.1.3.2/GhosttyKit.xcframework.zip",
            checksum: "764ee144fe7fb1abbc80bd7fa0f86e7aad96a8864c9e8974dba56fac3db214de"
        ),
        .testTarget(
            name: "GhosttyKitTest",
