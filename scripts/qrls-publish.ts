/**
 * 用 QRls 把已签名的 Qjiao 安装包发到 R2（主源），并可选同步到 GitHub。
...
export const R2_ONLINE_URL = (
  process.env.R2_ONLINE_URL ?? "https://download.qzrzz.com/qjiao"
).replace(/\/+$/, "");
...
/** R2 对象键前缀。 */
export const R2_PATH = process.env.R2_PATH ?? "qjiao";
 ...
 * @param build CURRENT_PROJECT_VERSION
 */
